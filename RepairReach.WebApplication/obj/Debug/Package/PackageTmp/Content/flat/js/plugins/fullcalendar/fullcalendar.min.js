...
e){e.className=e.className.replace(/^fc-\w*/,"fc-"+rc[b.getDay()])})}function Kb(a,b){var l=a.source||{},e=a.color,m=l.color,r=b("eventBackgroundColor"),A=a.backgroundColor||e||l.backgroundColor||m||b("eventBackgroundColor")||r;e=a.borderColor||e||l.borderColor||m||b("eventBorderColor")||r;a=a.textColor||l.textColor||b("eventTextColor");b=[];A&&b.push("background-color:"+A);e&&b.push("border-color:"+e);a&&b.push("color:"+a);return b.join(";")}function rb(a,b,l){if(t.isFunction(a))a=[a];if(a){var e,m;for(e=
