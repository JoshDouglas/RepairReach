...
namespace BusinessTracker.Data.Infrastructure.Initializers
{
    ...
    /// </summary>
    public class BusinessTrackerUserContextInitializer
        : DropCreateDatabaseAlways<BusinessTrackerUserContext>
    {
...
//        private string _smallPicturePath = "FakeImages\\{0} - small.jpg";
        ...
        protected override void Seed(BusinessTrackerUserContext context)
        {
