...
using BusinessTracker.Core.Enum;
using BusinessTracker.Core.Model;

namespace BusinessTracker.Data.Infrastructure.Initializers
{
    /// <summary>
    ...
    /// </summary>
    public class BusinessTrackerContextInitializer
        : DropCreateDatabaseAlways<BusinessTrackerContext>
    {
...
//        private string _smallPicturePath = "FakeImages\\{0} - small.jpg";
        ...
        protected override void Seed(BusinessTrackerContext context)
        {
            //CreateStaff(context);
...
//        private void CreateStaff(BusinessTrackerContext context)
//        {
//            context.Staff.Add(new Staff()
//            {
//                DisplayName = "Jon Douglas",
//                Email = "douglasjm@live.com",
//                FirstName = "Jon",
...
//                Phone = "801-644-9163",
//                StaffId = 1,
//                Title = UserTitleEnum.Owner
//
//            }
//                );
//        }

        //private void CreateQuestions(BusinessTrackerContext context)
        //{
        ...
        //private void CreateTeamManagers(BusinessTrackerContext context)
        //{
        //    int managersCount = 2;
        ...
        //private void CreateEmployees(BusinessTrackerContext context)
        //{
        ...
        //private void CreateEmployeePictures(BusinessTrackerContext context)
        //{
        ...
        //private void CreateTravels(BusinessTrackerContext context)
        //{
        //    foreach (var employee in context.Employees)
        //    {
        ...
        //private void CreateAttachment(BusinessTrackerContext context, TravelRequest travel)
        //{
        ...
        //{
        //    string path = new Uri(Assembly.GetAssembly(typeof(BusinessTrackerContextInitializer)).CodeBase).LocalPath;
